...
const EditModel = ({
    ...
    useEffect(() => {
        if (!loading && models.length > 0) {
            const currentModel: any = models.find(
                (model: any) => model._id === id
            );
            ...
            <div className="max-w-5xl p-16 mb-20 mx-auto bg-white border-[1.5px] border-black shadow-neo-lg">
                <div className="flex justify-between items-center mb-8 border-b pb-6">
                    <div className="flex flex-col gap-1">
                        <h1 className="text-4xl font-light uppercase tracking-tighter">Edit Model</h1>
                        <p className="text-gray-500 font-medium">Update model details and portfolio.</p>
                    </div>
                ...
                <form onSubmit={updateModel} className="space-y-16">
                    ...
                    >
                        {processing ? <ImSpinner8 className="animate-spin" /> : "Save Changes"}
                    </button>
                </form>
            </div>
        </PageLayout>
